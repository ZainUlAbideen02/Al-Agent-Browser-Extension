...
# Load viewport settings dynamically from environment variables
DEFAULT_VIEWPORT_WIDTH = int(os.getenv("VIEWPORT_WIDTH", "1280"))
DEFAULT_VIEWPORT_HEIGHT = int(os.getenv("VIEWPORT_HEIGHT", "800"))
...
class BrowserController:
    ...
    def __init__(
        ...
        self.width = width or DEFAULT_VIEWPORT_WIDTH
        self.height = height or DEFAULT_VIEWPORT_HEIGHT
    ...
    def scroll(self, direction: str = "down", amount: int = 500) -> None:
        ...
        self.mouse_scroll(delta_x=0, delta_y=delta_y)
